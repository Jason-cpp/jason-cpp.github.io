...
title:    " 采样总结"
subtitle:   "简要总结，不是教程"
date:     2019-11-18 13:19:24.000000000 +09:00
author:     "Jason"
...
![](../../../../img/GAN/5966d7da92f9c.jpeg)

![](../../../../img/GAN/2019-10-21 22-28-25屏幕截图.png)
...
![](../../../../img/GAN/2019-10-24 21-57-38屏幕截图.png)

## ACGAN

能够控制生成类别，

![](../../../../img/GAN/v2-2ad47451ac82a66f5edbf868e3afe69a_r.jpg)

G第一层：`self.label_emb = nn.Embedding(opt.n_classes, opt.latent_dim)`

使用embedding的方法。

![](../../../../img/GAN/2019-10-21 23-35-25屏幕截图.png)
...
![](../../../../img/GAN/2019-10-21 23-51-03屏幕截图.png)
...
![](../../../../img/GAN/2019-10-22 10-33-49屏幕截图.png)

使用Wasserstein loss来衡量real_loss和fake_loss分布之间的差距



![](../../../../img/GAN/2019-10-22 10-37-01屏幕截图.png)

![](../../../../img/GAN/2019-10-22 10-47-58屏幕截图.png)

![](../../../../img/GAN/2019-10-22 10-49-29屏幕截图.png)
...
![](../../../../img/GAN/2019-10-22 10-57-51屏幕截图.png)
...
![](../../../../img/GAN/2019-10-22 11-02-04屏幕截图.png)
...
![](../../../../img/GAN/2019-10-23 00-03-41屏幕截图.png)

利用离散连续混合采样，平衡聚类和插值。

损失函数$q(x)$ 是可以使$q(x)=log(x)$或者是$q(x)=x$(WGAN)

![](../../../../img/GAN/2019-10-23 15-13-10屏幕截图.png)
...
![](../../../../img/GAN/2019-10-23 15-37-40屏幕截图.png)
...
![](../../../../img/GAN/2019-10-23 16-41-35屏幕截图.png)

![](../../../../img/GAN/2019-10-23 16-45-17屏幕截图.png)

第二个版本，更加重视对fake的判断

![](../../../../img/GAN/2019-10-23 16-45-56屏幕截图.png)



第三个版本

![](../../../../img/GAN/2019-10-23 16-46-36屏幕截图.png)
...
![](../../../../img/GAN/2018083112514829.webp)

<img src="../../../../img/GAN/2019-10-23 18-01-34屏幕截图.png" style="zoom:150%;" />

<img src="../../../../img/GAN/2019-10-23 18-02-34屏幕截图.png" style="zoom:150%;" />

<img src="../../../../img/GAN/2019-10-23 18-02-49屏幕截图.png" style="zoom:150%;" />
...
![](../../../../img/GAN/2019-10-23 18-33-03屏幕截图.png)

通过参数共享，通过两个边缘分布，就可以学习到两个分布的联合分布

另一种形式，也可以用下面的形式，或者，加参数共享，cycle,等保证中间的latent-space分布一致

![](../../../../img/GAN/2019-10-24 20-29-55屏幕截图.png)

## CycleGAN



![](../../../../img/GAN/687474703a2f2f6572696b6c696e6465726e6f72656e2e73652f696d616765732f6379636c6567616e2e706e67.png)
...
![](../../../../img/GAN/2019-10-28 14-10-20屏幕截图.png)

## DiscoGAN

跟cyclegan一个东西就是用了两个D

![](../../../../img/GAN/2019-10-28 14-14-35屏幕截图.png)
...
![](../../../../img/GAN/2019-10-28 14-23-45屏幕截图.png)

![](../../../../img/GAN/2019-10-28 14-42-55屏幕截图.png)
...
![](../../../../img/GAN/2019-10-28 14-48-35屏幕截图.png)
...
![](../../../../img/GAN/2019-10-28 15-16-52屏幕截图.png)

![](../../../../img/GAN/2019-10-28 15-17-28屏幕截图.png)

![](../../../../img/GAN/2019-10-28 15-15-57屏幕截图.png)

![](../../../../img/GAN/2019-10-28 15-18-13屏幕截图.png)
...
![](../../../../img/GAN/005HR30kly1ft9rfczy62j30k00duwis.jpg)

类似acgan

最大化互信息c,和x使得可以通过控制c来控制生成的图片

![](../../../../img/GAN/2019-10-28 17-59-44屏幕截图.png)

![](../../../../img/GAN/2019-10-28 18-00-20屏幕截图.png)

使用辅助分布，$H(c)$可以看做是常数



![](../../../../img/GAN/2019-10-28 18-00-47屏幕截图.png)
...
![](../../../../img/GAN/2019-10-28 18-17-27屏幕截图.png)

好像就是cyclegan的扩展，多个model多个G,D......

## pixel2pixel

![](../../../../img/GAN/2019-10-28 19-24-52屏幕截图.png)

![](../../../../img/GAN/2019-10-28 19-25-08屏幕截图.png)

## PixelDA

![](../../../../img/GAN/2019-10-28 19-50-06屏幕截图.png)

![](../../../../img/GAN/2019-10-28 19-52-03屏幕截图.png)
...
![](../../../../img/GAN/2019-10-29 09-29-17屏幕截图.png)

![](../../../../img/GAN/2019-10-29 09-31-05屏幕截图.png)
...
![](../../../../img/GAN/2019-10-29 09-33-07屏幕截图.png)

##  Softmax GAN

![](../../../../img/GAN/2019-10-29 09-40-36屏幕截图.png)

## StarGAN

![](../../../../img/GAN/2019-10-29 09-46-49屏幕截图.png)

![](../../../../img/GAN/2019-10-29 09-50-05屏幕截图.png)

## RSGAN



![](../../../../img/GAN/2019-10-29 09-55-02屏幕截图.png)

![](../../../../img/GAN/2019-10-29 09-55-27屏幕截图.png)

## UNIT

跟cogan一样

![](../../../../img/GAN/2019-10-29 10-00-26屏幕截图.png)



## VAEGAN

![](../../../../img/GAN/2019-10-29 16-05-23屏幕截图.png)



![](../../../../img/GAN/2019-10-29 16-05-10屏幕截图.png)
...
![](../../../../img/GAN/2018101814423353.png)

![](../../../../img/GAN/20181018153634480.png)

![](../../../../img/GAN/2018101815375483.png)

![](../../../../img/GAN/2019-10-29 10-44-12屏幕截图.png)
