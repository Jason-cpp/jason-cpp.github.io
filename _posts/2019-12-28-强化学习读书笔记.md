...
$=E[(R_t-\bar{R}_{t})\frac{\partial \pi_t(A_t)}{\partial H_t(a)}/\pi_t(A_t)]$

因为$E[R_t\|A_t]=q_*(A_t)$

$=E[(R_t-\bar{R}_{t})\pi_t(A_t)(I_{a=A_t}-\pi_t(a))/\pi_t(A_t)]$

$=E[(R_t-\bar{R}_{t})(I_{a=A_t}-\pi_t(a))]$
...
![](../../../../img/RL/2019-12-28 16-28-21屏幕截图.png)
